...
public class RedisConfig {
	...
	public RedisConnectionFactory redisConnectionFactory() {
		...
		RedisStandaloneConfiguration redisConfig = new RedisStandaloneConfiguration("quiet-mastodon-27519.upstash.io",
				6379);
		redisConfig.setUsername("default");
		redisConfig.setPassword("AWt_AAIncDE0ZTI1MGM4OWVhOGE0YmQ3YTUwOTgwYjlhNWI0NTQ0MnAxMjc1MTk");
